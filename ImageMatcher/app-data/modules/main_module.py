...
from modules.submission_module import SubmissionModule
from modules.image_matcher_module import ImageMatcher
...
class MainModule:
    ...
    def make_matching(self, scene_path, layout_path, refinement=True):
        ...
        result = self.submission_module.write_results_to_csv_file(file_path='coords.csv',
